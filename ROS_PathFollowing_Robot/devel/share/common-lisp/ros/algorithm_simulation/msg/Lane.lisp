...
(cl:in-package algorithm_simulation-msg)
...
(cl:defclass <Lane> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector algorithm_simulation-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'algorithm_simulation-msg:Waypoint :initial-element (cl:make-instance 'algorithm_simulation-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name algorithm_simulation-msg:<Lane> is deprecated: use algorithm_simulation-msg:Lane instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader algorithm_simulation-msg:header-val is deprecated.  Use algorithm_simulation-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader algorithm_simulation-msg:waypoints-val is deprecated.  Use algorithm_simulation-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Lane>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'algorithm_simulation-msg:Waypoint))
