...
(cl:defclass <Lane> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector real_robot-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'real_robot-msg:Waypoint :initial-element (cl:make-instance 'real_robot-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Lane>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lane)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name real_robot-msg:<Lane> is deprecated: use real_robot-msg:Lane instead.")))
...
(cl:defmethod waypoints-val ((m <Lane>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader real_robot-msg:waypoints-val is deprecated.  Use real_robot-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Lane>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'real_robot-msg:Waypoint))
