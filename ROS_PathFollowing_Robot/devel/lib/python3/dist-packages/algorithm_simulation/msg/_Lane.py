...
"""autogenerated by genpy from algorithm_simulation/Lane.msg. Do not edit."""
import codecs
import sys
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','algorithm_simulation/Waypoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = algorithm_simulation.msg.Waypoint()
        _v13 = val1.pose
        _v14 = _v13.header
        start = end
        end += 4
